      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div onMouseEnter={triggerUnifiedReplay} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            >
              <div className="h-[220px] sm:h-[260px] lg:h-[300px] w-full mt-4 flex items-center justify-center">
                {mounted ? (
              ...
              title={
                <div className="flex items-center gap-2">
                  ...
                  <span className="relative flex h-2 w-2">
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-fyn-pink shadow-[0_0_14px_rgba(232,25,122,0.5)]"></span>
                  </span>
                </div>
              }
