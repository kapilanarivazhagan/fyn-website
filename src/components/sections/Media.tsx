  ...
  return (
    ...
    >
      <img
        ...
        loading="lazy"
        decoding="async"
        className="absolute inset-0 h-full w-full object-cover opacity-75 transition duration-500 group-hover:scale-[1.035] group-hover:opacity-90"
      />
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden">
        <img
          ...
          loading="lazy"
          decoding="async"
          className="absolute inset-0 h-full w-full object-cover opacity-75 transition duration-500 group-hover:scale-[1.04] group-hover:opacity-90"
        />
